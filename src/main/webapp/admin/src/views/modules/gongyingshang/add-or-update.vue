    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="供应商名称" prop="name">
                              <el-input v-model="ruleForm.name"
                                        placeholder="供应商名称" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="供应商名称" prop="name">
                                  <el-input v-model="ruleForm.name"
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="供应商品" prop="goods">
                              <el-input v-model="ruleForm.goods"
                                        placeholder="供应商品" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="供应商品" prop="goods">
                                  <el-input v-model="ruleForm.goods"
                                            placeholder="供应商品" readonly></el-input>
                              </el-form-item>
                          </div>
                      </el-col>
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="供应商联系方式" prop="phone">
                              <el-input v-model="ruleForm.phone"
                                        placeholder="供应商联系方式" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="供应商联系方式" prop="phone">
                                  <el-input v-model="ruleForm.phone"
        ...
        data() {
            ...
            return {
                ...
                rules: {
                        ...
                        goods: [
                        { required: true, message: '供应商品不能为空', trigger: 'blur' },
                    ],
